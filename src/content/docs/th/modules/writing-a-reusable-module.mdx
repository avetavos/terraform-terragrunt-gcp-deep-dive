...
description: 'module คืออะไรกันแน่ ทำไม file layout ถึงเหมือนกับ root configuration และวิธีออกแบบให้มี responsibility เดียวที่ชัดเจน'
sidebar:
  order: 1
---
...
export const quizWritingReusableModule = [
  ...
  },
  {
    ...
    options: [
      ...
      'เพราะ caller แต่ละคนต้องการชื่อ bucket ที่ต่างกันจริง ๆ โดยไม่มี default ที่สมเหตุสมผล ส่วน caller ส่วนใหญ่พอใจกับ behavior เดิมของ force_destroy',
