...
description: 'Terraform workspace ทำให้ configuration เดียวจัดการหลาย state ที่มีชื่อได้ยังไง และทำไมมันยังใช้ backend กับ provider configuration ร่วมกันอยู่'
sidebar:
  order: 2
---
...
export const quizTerraformWorkspaces = [
  {
    ...
    options: [
      ...
      'state file ที่แยกกันในแต่ละ workspace ในขณะที่ backend, provider configuration, และโค้ด .tf ยังใช้ร่วมกัน',
  ...
  },
  {
    ...
    options: [
      ...
      'block backend และ block provider รวมถึง GCP project ที่มันชี้ไป',
