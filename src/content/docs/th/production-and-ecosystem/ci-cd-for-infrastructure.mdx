...
export const quizCicdPipeline = [
  ...
  },
  {
    ...
    options: [
      'resource นั้นจะ update in-place โดยไม่มี downtime',
      ...
      'resource นั้นจะ import จาก infrastructure ที่มีอยู่แล้ว',
    ],
    answer: 1,
  },
  {
    ...
    options: [
      ...
      'ออก credential แบบ short-lived และ scope เฉพาะแต่ละ run โดยให้ CI system แลก identity token ที่ trust ได้เป็น access ชั่วคราวผ่านการ impersonate service account เลยไม่ต้องมี key file ให้ดาวน์โหลด เก็บ หรือหมุนเวียนใน CI อีกเลย',
